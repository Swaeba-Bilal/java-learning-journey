...
<li class="nav-item"><a class="nav-link" href="about.jsp active">About</a></li>
</ul>
</div>
</div>
</nav>
...
It allows administrator to manage student records efficiently, including adding,updating, viewing,
...
<!-- Footer -->
<footer class="bg-dark text-white text-centre py-3">
